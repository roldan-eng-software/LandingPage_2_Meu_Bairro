...
const EMAILJS_CONFIG = {
  publicKey: 'YOUR_PUBLIC_KEY', // Substitua pelo seu Public Key
  serviceId: 'service_meubairro', // Substitua pelo seu Service ID
  templateIdUser: 'template_user', // Template para o usuário
  templateIdAdmin: 'template_admin' // Template para notificação admin
};
